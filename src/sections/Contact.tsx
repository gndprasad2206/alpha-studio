        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mt-16 max-w-6xl mx-auto">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">123 Studio Street, Creative District, NY 10001</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">hello@alphastudio.com</p>
                </div>
              </div>
            </div>
            ...
            <div className="w-full h-64 rounded-2xl overflow-hidden border border-white/10 grayscale hover:grayscale-0 transition-all duration-500">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1m2!1m3!1m2!1m3!1m2!1m3!1m2!1m3!1m2!1m3" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
